...
namespace Program1
{
    ...
    public class OrderService
    {
        ...
        //XML序列化
        public static FileInfo XmlSerializeExport(XmlSerializer ser, string filename, object obj)
        {
        ...
        //XML反序列化
        public static OrderService XmlDeserilizeImport(XmlSerializer ser, string filename, object obj)
        {
            FileStream fs = new FileStream(filename, FileMode.Open, FileAccess.Read);
            List<Order> orders = (List<Order>)ser.Deserialize(fs);
            fs.Close();
